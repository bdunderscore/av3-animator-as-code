...
namespace AnimatorAsCode.V0
{
    public static class AacV0
    {
        ...
        internal static AnimatorController AnimatorOf(VRCAvatarDescriptor ad,
        ...
        {
            clip.name = "zAutogenerated__" + component.AssetKey + "__" + suffix + "_" +
    ...
    public struct AacFlLayer
    {
        ...
        internal AacFlLayer(AnimatorController animatorController, AacConfiguration configuration,
            AacFlStateMachine stateMachine, string fullLayerName)
        {
    ...
    public class AacFlBase
    {
        ...
        {
            var layers = _configuration.AvatarDescriptor.baseAnimationLayers.Select(layer => layer.animatorController)
                .Where(layer => layer != null).Distinct().ToList();
        ...
        public AacFlLayer CreateMainArbitraryControllerLayer(AnimatorController controller) => DoCreateLayer(controller,
            _configuration.DefaultsProvider.ConvertLayerName(_configuration.SystemName));

        public AacFlLayer CreateSupportingArbitraryControllerLayer(AnimatorController controller, string suffix) =>
            DoCreateLayer(controller,
                _configuration.DefaultsProvider.ConvertLayerNameWithSuffix(_configuration.SystemName, suffix));
        ...
        private AacFlLayer DoCreateSupportingLayerOnController(VRCAvatarDescriptor.AnimLayerType animType,
            string suffix)
        {
            var animator = AacV0.AnimatorOf(_configuration.AvatarDescriptor, animType);
            var layerName =
        ...
        {
            var allSubAssets =
                AssetDatabase.LoadAllAssetsAtPath(AssetDatabase.GetAssetPath(_configuration.AssetContainer));
    ...
    public class AacVrcAssetLibrary
    {
        ...
        {
            return AssetDatabase.LoadAssetAtPath<AnimationClip>("Assets/VRCSDK/Examples3/Animation/ProxyAnim/" +
    ...
    public class AacAnimatorGenerator
    {
        ...
        internal AacAnimatorGenerator(AnimatorController animatorController, AnimationClip emptyClip,
        ...
        internal AacFlStateMachine CreateOrRemakeLayerAtSameIndex(string layerName, float weightWhenCreating,
            AvatarMask maskWhenCreating = null)
        {
            ...
            var machinist = new AacFlStateMachine(layer.stateMachine, _emptyClip, new AacBackingAnimator(this),
                _defaultsProvider);
            return machinist
        ...
        internal AacFlStateMachine CreateOrClearLayerAtSameIndex(string layerName, float weightWhenCreating,
            AvatarMask maskWhenCreating = null)
        {
            var originalIndexToPreserveOrdering = FindIndexOf(layerName);
            if (originalIndexToPreserveOrdering != -1)
            {
                RecursivelyClearChildrenMachines(_animatorController.layers[originalIndexToPreserveOrdering]
                    .stateMachine);

                _animatorController.layers[originalIndexToPreserveOrdering].stateMachine.stateMachines =
                ...
                _animatorController.layers[originalIndexToPreserveOrdering].stateMachine.entryTransitions =
                    new AnimatorTransition[0];
                _animatorController.layers[originalIndexToPreserveOrdering].stateMachine.anyStateTransitions =
